...
/// Сункци§ PrintMatrix() печатает элементы матрицы <i>matrix</i> на консоль;
...
/// Сункци§ FindAverageValues() находит средние значени§ в матрице <i>matrix</i>
...
/// Сункци§ PrintAverageVals() печатает элементы массива <i>average_vals</i> на консоль;
...
bool main()
{
	...
	const bool ERROR_STATUS = false;
	const bool OK_STATUS = true;

	bool status = OK_STATUS;
